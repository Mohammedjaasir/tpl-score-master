...
export const TPL_STATISTICS_METHODOLOGY: Record<string, MetricMethodology> = {
  ...
  overs_bowled: {
    ...
    name: "Overs Bowled",
    category: "BOWLING",
    description: "Total completed overs plus remainder legal deliveries (5 balls per over).",
    scope: "BOTH",
    sourceData: "Count of legal balls bowled.",
    formula: "FLOOR(legal_balls / 5) + '.' + (legal_balls % 5)",
    qualification: "None.",
    rankingRule: "Descending by total legal balls.",
    tieBreakRule: "N/A",
    roundingRule: "Standard tournament cricket notation (e.g. 1.4 overs = 9 balls).",
  ...
  economy: {
    ...
    category: "BOWLING",
    description: "Average runs conceded per 5 legal deliveries bowled.",
    scope: "BOTH",
    sourceData: "Total runs conceded / (Total legal balls / 5).",
    formula: "(Runs Conceded / Legal Balls Bowled) * 5",
    qualification: "Tournament Best Economy: Minimum 2 overs (10 legal balls).",
